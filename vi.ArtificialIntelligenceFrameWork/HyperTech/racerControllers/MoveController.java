...
public class MoveController {
	...
	public void jump(float length) {
		/*TODO*/
		//player.getLocalTranslation().y+=gameSingleton.getStats().getFallRate(((RacerNode)player).getCharacterStates()[5]*20);
	}
	public RacerNode getNode(){return player;}
