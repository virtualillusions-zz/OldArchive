...
public abstract class SceneNode extends Node implements Serializable,HyperNode{
		...
		public SceneNode startup(){
			...
			CullState cs = gameSingleton.get().getDisplay.getRenderer().createCullState();
		...
		public void fogState(){
			fs = gameSingleton.get().getDisplay.getRenderer().createFogState();
			fs.setDensity(.005f);	     
