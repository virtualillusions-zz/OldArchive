 ...
 */
public class testCharacterLoad extends SimpleApplication implements BindingListener{

    public static void main(String[] args){
        testCharacterLoad app = new testCharacterLoad();
        app.start();
    }
