...
public abstract class VezlaApplication extends Application{
    ...
    protected com.jme3.bullet.PhysicsSpace pSpace;
    ...
    public com.vza.director.PhysicsDirector getPhysicsDirector(){return getAppStateManager().getState(com.vza.director.PhysicsDirector.class);}
    ...
    public void update(){
        ...
        //Special Update Sequence
        getPhysicsDirector().physicsUpdate(tpf);
    }
