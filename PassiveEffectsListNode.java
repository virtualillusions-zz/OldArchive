 ...
 */
class PassiveEffectsListNode extends AbstractNode {

    public PassiveEffectsListNode(ArrayList<Effect> key, ChangeSupport cs) {
        super(Children.create(new EffectChildren(key, cs), true), Lookups.fixed(key, cs));
        setDisplayName("Passive Effects");
    }

    @Override
    public String getHtmlDisplayName() {
        return "<font color='!textText'>Passive Effects</font>";
    }
                    ...
                    new AbstractAction("Create New Effect") {
                        ...
                        public void actionPerformed(ActionEvent e) {
                            ...
                            if (create == JOptionPane.YES_OPTION) {/*
                                 ...
                                 */
                                Effect effect = new Effect(EffectType.Passive);
