...
public class modelDirector implements Director,BindingListener{
	...
	public void update(float tpf) {
		root.getChild("testBox").updateGeometricState();
		root.getParent().getChild("sceneNode").updateGeometricState();
		 BoundingVolume pVol = root.getChild("testBox").getWorldBound();
		 Node platforms = (Node) root.getParent().getChild("sceneNode");
         BoundingVolume vVol = platforms.getChild("platform").getWorldBound();
