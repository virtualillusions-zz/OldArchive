 ...
 */
public abstract class ButtonSequence1 extends java.util.ArrayList<String>{
    ...
    protected final float TIME_LIMIT = 0.05f;   //5000 miliseconds
    ...
    public void resetRecordTime(){
        ...
        constraint=true; //This constraint is set True here so anytime a button is pressed it is set to Two
        ...
        return new com.jme3.input.controls.ActionListener(){
            public void onAction(String name, boolean isPressed, float tpf) {
                ...
                //////////////////////////////////TODO: FIGURE OUT BUTTON TIMING THEIR SEEMS TO BE A SLIGHT ISSUE WITH RAPID INPUT REGISTRATION
                 if (isPressed){
                        addButton(name.split("-")[1]);//This is done to take only the important part of the input say testPlayer-Attack4->Attack4
                 }else{
                        releaseButton();
                }              
            }
