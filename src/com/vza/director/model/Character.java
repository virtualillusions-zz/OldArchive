...
import com.vza.director.model.controller.MoveController;
...
public final class Character{
     ...
     * @throws IOException
     */
    public Character(String name,String balanceType, String bio) throws IOException{
        this.name=name;
        this.bio=bio;
    ...
    character = new PhysicsCharacterNode(model,capsule, 1f);
    character.setName(name+"-physics");
    ...
    model.addControl(inputController);  //This controller requires both gauge and target controller to be initialized before hand
    MoveController moveController = new MoveController();
    inputController.addMoveController(moveController);
    //MOVECONTROLLER MUST BE INITIATED AFTER ANIMATIONINPUT CONTROLLER
    //TODO: BECAUSE OF SOME INITIAL ISSUES MOVECONTROLLER MUST ALSO BE INITIATED INSIDE ANIMATIONINPUT CONTROLLER
    character.addControl(moveController); //THIS USE OF THIS CONTROLLER IS RESTRICTED
    }
