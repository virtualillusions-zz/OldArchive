 ...
 */
public class AnimationController extends com.jme3.scene.control.AbstractControl implements AnimEventListener{
     ...
     * @param specialType 
     */
    public AnimationController(String[] basicMoveSet,SpecialMovement specialType){
