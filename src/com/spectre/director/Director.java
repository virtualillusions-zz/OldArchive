...
public final class Director extends com.spectre.app.SpectreState{
     ...
     * @return application
     */
    public static SpectreApplication getApp(){return application;}
     ...
     */
    public static  BulletAppState getPhysicsDirector(){return physicsDirector;}

    /**
     * @see com.jme3.bullet.PhysicsSpace
     * @return physicsSpace
     */
    public static com.jme3.bullet.PhysicsSpace getPhysicsSpace(){return physicsDirector.getPhysicsSpace();}    


    /**
     * Returns if the models have been loaded or not
     */
    public static boolean modelsAreLoaded(){return characterList!=null;}

    /**
     * A Loaded List of all models
     * @param cL
     */
    public static void setCharacterList(HashMap<String, CharacterController> cL){characterList=cL;}
    ...
    * Returns if the models have been loaded or not
    */
    public static boolean scenesAreLoaded(){return sceneList!=null;}

    /**
     * A Loaded List of all models
     * @param cL
     */
    public static void setSceneList(HashMap<String, Spatial> sL){sceneList=sL;}
    /**
     * A Loaded List of all Cards
     * @param deck 
     */
    public static void setCardList(MasterDeck deck) {cardList=deck;}
    /**
     * A Loaded List of all Cards
     * @param deck 
     */
    public static MasterDeck getCardList(HashMap<String, Card> deck) {return cardList;}
     /**
    ...
    public static com.jme3.scene.Node getModelNode(){return application.getModelNode();}
    /**@see com.spectre.app.SpectreApplication#getSceneNode()*/
    public static com.jme3.scene.Node getSceneNode(){return application.getSceneNode();}
     ...
     */
    public static <C extends com.jme3.app.state.AppState>C getAppState(Class<C> stateClass){return stateManager.getState(stateClass);}
