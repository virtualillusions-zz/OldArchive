...
public class TerrainManager{
	...
	public void registerTerrains(){
		try {
	terrainList = (HashMap<String, Node>) FileClassLoader.loadNodeClasses(
									new File(TerrainManager.class.getClassLoader()
	  ...
	  /**the TerrainManager's cleanup function*/
		public void cleanup(){Handler.detachAllChildren(); Handler=null;terrainList.clear();terrainList=null;}
