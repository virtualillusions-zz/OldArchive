...
public class characterManager extends BasicGameState{	
	...
	/**retrieves an isntance of the characterManager*/
	public static characterManager get(){
		if(instance ==null){instance = new characterManager();}return instance;
	}
	//store character nodes
	public  static HashMap<String, characterNode> charList = new HashMap<String, characterNode>();  
	 ...
	 */
	public characterNode Manager(String instanceName) {return charList.get(instanceName);}
