 ...
 */
public abstract class AbstractNewParticleEmitterWizardAction implements NewEmitterAction {

    protected String name = "*";

    protected abstract Object showWizard(org.openide.nodes.Node node);

    protected abstract ParticleEmitter doCreateEmitter(Node parent, Object configuration);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                SceneApplication.getApplication().enqueue(new Callable<Void>() {
                    ...
                    public Void call() throws Exception {
                        final ParticleEmitter filter = doCreateEmitter(rootNode.getEmitterNode(), obj);
                        if (filter != null) {
