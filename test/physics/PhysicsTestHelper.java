...
public class PhysicsTestHelper {
    ...
    public static void createPhysicsDemoWorld(Application app,Node rootNode, AssetManager assetManager, PhysicsSpace space){
        ...
        material.setTexture("ColorMap", assetManager.loadTexture("testData/Logo/Monkey.jpg"));
        //immovable sphere with mesh collision shape
        Sphere sphere = new Sphere(64, 64, 20);
        Geometry planet = new Geometry("Sphere", sphere);
    ...
    public static void createBallShooter(final Application app, final Node rootNode, final PhysicsSpace space) {
        ActionListener actionListener = new ActionListener() {
            ...
            public void onAction(String name, boolean keyPressed, float tpf) {
                ...
                TextureKey key2 = new TextureKey("testData/Logo/Monkey.jpg");
        ...
        app.getInputManager().addMapping("shoot", new MouseButtonTrigger(MouseInput.BUTTON_MIDDLE));
