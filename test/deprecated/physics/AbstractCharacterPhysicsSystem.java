...
import com.spectre.scene.camera.components.CameraLeftPiece;
...
import com.spectre.systems.input.InputSpectreAppState;
...
import deprecated.physics.components.DashPiece;
import deprecated.physics.components.DirectionForwardPiece;
import deprecated.physics.components.DirectionLeftPiece;
import deprecated.physics.components.EvadePiece;
import deprecated.physics.components.JumpPiece;
import deprecated.physics.components.PhysicsDampingPiece;
import deprecated.physics.components.RigidBodyLocationPiece;
import deprecated.physics.components.ViewDirectionPiece;
import deprecated.physics.components.WalkDirectionPiece;
...
public abstract class AbstractCharacterPhysicsSystem extends InputSpectreAppState implements PhysicsTickListener, PhysicsCollisionListener {
    ...
    public void SpectreAppState(SpectreApplicationState sAppState) {
        ...
        this.mainSet = ed.getEntities(filter, VisualRepPiece.class, InScenePiece.class);
        this.physicsDataSet = ed.getEntities(ActionModePiece.class, DashPiece.class,
        ...
        this.camSet = ed.getEntities(CameraDirectionPiece.class, CameraLeftPiece.class);
    ...
    public void removeAllProperties(EntityId id) {
        ...
        for (EntityComponent ec : e.getComponents()) {
            ed.removeComponent(id, ec.getClass());
        }
